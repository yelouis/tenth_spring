...
- [ ] **Item 1** — both platform branches asserted with explicit overrides; Android background-permission flow routes to settings and degrades gracefully; ledger shows background state.
